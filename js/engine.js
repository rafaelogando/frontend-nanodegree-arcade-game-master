...
var Engine = (function(global) {
    ...
    function render() {
        ...
        //Shows on screen how many points and hearts the player has and check if 
        //the game continues.
        ctx.fillStyle="white";
        ctx.fillText("points "+player.points,30,570);
        ctx.strokeText("points " +player.points ,30,570);
        Over();

        for(rowheart=1;rowheart<=player.hearts;rowheart++)
        {
            ctx.drawImage(Resources.get("images/Heart.png"),rowheart*101,440);
        }
